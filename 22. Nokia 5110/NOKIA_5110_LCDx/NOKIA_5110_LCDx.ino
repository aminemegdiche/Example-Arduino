...
// PIN 1 RST -> Arduino pin D6
// PIN 2 CE  -> Arduino pin D7
// PIN 3 DC  -> Arduino pin D5
// PIN 4 DIN -> Arduino pin D4
// PIN 5 CLK -> Arduino pin D3
// PIN 6 VCC -> +3.3V lub 5V
// Pin 7 LIGHT -> 180 OHM+GND(przy 3.3V) / 330 OHM+GND(przy 5V) 
// PIN 8 GND -> GND
...
void LcdInitialise(void)
{
  ...
  LcdWrite(LCD_C, 0xC0); //0xB1 );  // Set LCD Vop (Contrast). 
